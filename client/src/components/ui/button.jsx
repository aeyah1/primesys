  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-[--color-surface] text-[--color-text-primary] border border-[--color-border] hover:border-[--color-border-strong] hover:bg-[--color-overlay] shadow-xs hover:shadow-sm hover:-translate-y-px',

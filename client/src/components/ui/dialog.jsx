    ...
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          ...
          // Never taller than the window: the title stays put and the body scrolls
          // (the page behind is locked while a dialog is open).
      ...
      >
        {(title || description) && (
          <div className="shrink-0 px-6 pt-6 pb-5 border-b border-[--color-border]">
